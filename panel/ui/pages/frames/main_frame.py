...
def frame(full_size: bool = False):
    ...
    ui.page_title("Somali-Ware")

    with ui.left_drawer().classes(
        "flex flex-col justify-between items-center h-full w-full overflow-auto"
        ...
        with ui.column().props("vertical inline-label indicator-color='blue'").classes(
            ...
            ui.image(Images.get_image("SomaliWare")).classes(
    ...
    with ui.header().classes(replace="row items-center"):
        ...
        ui.label("Somali-Ware").classes("text-white text-2xl justify-center mx-auto")
